...
{
	system("CLS");
    printf("\tPRICE LIST\n=$=$=$=$=$=$=$=$=$=$=$=$=$=$=\n1. AA - Avengers infinity war - Rs 3000\n2. BB - Bahubali - Rs 5000\n3. CC - Lord of war - Rs 2000\n4. DD - Catch me if you can - Rs 10000\n"
           "5. EE - Raatchasi - Rs 12000\n6. FF - 8 Mile - Rs 5000\n7. GG - K.G.F - Rs 7000\n8. HH - kimitsu no yaiba - Rs 8000\n9. II - shingeki no kyojin - Rs 12000\n10. JJ - Dil Bechara - Rs 14000\n");
}
...
void checking_ticket(userprofile *hello)
{
    ...
    printf("You have booked %d tickets for a sum total of Rs %f for ticket code %s\n",hello->user_numtick,tot,hello->user_place);
}
...
void booking_ticket(userprofile *hello)
{
    ...
    {
        printf("That show code doesn't exist\n");
        return;
    }
...
void cancelling_ticket(userprofile *hello)
{
    ...
    {
        printf("You haven't booked a show yet\n");
        return;
    }
    if(flag==0)
    {
        printf("Your ticket has been successfully cancelled\nA refund of Rs %f for show Code %s for %d tickets will soon be made to your original source of purchase\n",hello->ticket_price,hello->user_place,hello->user_numtick);
